 ...
 *
 */
public abstract class Task implements Resettable,Disposable {
    ...
    public final static int OP_BUFFER = 32;
    public final static int OP_TRANS = 64;
    ...
    private volatile long _timeout = 30000;//30s
