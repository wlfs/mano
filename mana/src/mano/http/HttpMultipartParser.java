...
public class HttpMultipartParser implements HttpEntityBodyHandler {
    ...
    @Override
    public void onRead(Buffer buffer, HttpRequestAppender appender) throws UnsupportedEncodingException, HttpException, IOException {
    ...
    void readHeaders(Buffer buffer) throws UnsupportedEncodingException, HttpException, IOException {
        String line;
    ...
    private void Data(Buffer buffer, HttpRequestAppender appender) throws IOException {
    ...
    private int findBoundary(boolean first, Buffer buffer) {
